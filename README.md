...
برای مدیریت state از **useReducer** و **Context API** استفاده شده است.
...
برای مشاهده قسمت های مختلف برنامه می‌توانید به پوشه زیر مراجعه کنید:

project-screenshots

در این پوشه تصاویر مربوط به قسمت های مختلف پروژه قرار داده شده است.
